...
const Login = ({handleLoginStatus}) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:9998/login', {
        method: 'POST',
        headers: {
...
const fetchData = async () => {
  try {
    ...
    const response = await axios.get('http://localhost:9998/protected', {
      headers: {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:9998/signup', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
